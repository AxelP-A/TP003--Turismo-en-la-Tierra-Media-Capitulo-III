...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
	<div class="container">
		<a class="navbar-brand" href="/Tp003-TurismoEnLaTierraMedia/index.jsp">Turismo en la Tierra Media</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/Tp003-TurismoEnLaTierraMedia/atraccion/index.do">Atracciones</a></li>
			</ul>
			<ul class="navbar-nav">
