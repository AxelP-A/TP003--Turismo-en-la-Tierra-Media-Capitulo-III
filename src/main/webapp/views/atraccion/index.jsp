	...
	<main class="mainSugeribles">
						...
						<c:when test="${user.admin}">
							...
							<c:forEach items="${atraccion}" var="atraccion">
								<tr>
									...
									<!-- 	<c:choose>
									<c:when test="${!atraccion.esPromo()}"> 
								<td><a href="#modal1"><i class="fas fa-angle-double-right"></i></a></td> 
								</c:when>
								<c:otherwise>
								<td class="open-promo"><a href="#modal1"><i class="fas fa-angle-double-right"></i></a></td>
								</c:otherwise>
								</c:choose> -->
		...
		<!--  <div class="container-all" id="modal1">
			<div class="popup">
				...
				<div class="container-text">
					<h2>Moria</h2>
					<p>Fue fundada por Durin I el Inmortal en los albores de la Primera Edad en las cuevas que daban a Azanulbizar. Se encontraban en el centro de las montañas Nubladas, bajo los picos Caradhras, monte Nuboso y Cuerno de Plata.</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
		...
		<div class="container-all" id="modal2">
			<div class="popup">
				...
				<div class="container-text">
					<h2>Minas Tirith</h2>
					<p>En la Tercera Edad, se llamó Minas Tirith a la ciudad capital del reino de Gondor. Originalmente se le conoció como Minas Anor (Torre del Sol, en sindarin), adoptando el nuevo nombre tras el cambio de capital, tras la decadencia de la antigua capital Osgiliath</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal3">
			<div class="popup">
				...
				<div class="container-text">
					<h2>La Comarca</h2>
					<p>La Comarca (The Shire en inglés) es el nombre que recibe la región de la Tierra Media en la que viven los Hobbits, una raza emparentada con los Hombres que se asentó en esta zona a mediados de la Tercera Edad</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal4">
			<div class="popup">
				...
				<div class="container-text">
					<h2>Mordor</h2>
					<p>En esta región principalmente volcánica, situada al este de Gondor, Sauron forjó el Anillo Único en las fraguas del Monte del Destino, hacia el año 1600 SE, con el objetivo de dominar por completo a los pueblos de la Tierra Media. Miles de años después, Mordor se convirtió en el escenario de las últimas aventuras de los miembros de la Comunidad del Anillo en su afán por destruir el Anillo Único, durante la Guerra del Anillo.3​</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal5">
			<div class="popup">
				...
				<div class="container-text">
					...
					<p>La Batalla del Abismo de Helm es una batalla pertenciente a la Guerra del Anillo en la que se enfrentaron las fuerzas de Rohan y las de Isengard. Participaron también varios miembros de la Comunidad del Anillo y los ucornos.</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal6">
			<div class="popup">
				...
				<div class="container-text">
					<h2>Lothlorien</h2>
					<p>En el universo imaginario de J. R. R. Tolkien y en la novela El Señor de los Anillos, Lothlórien es un reino élfico de la Tierra Media, ubicado al este de las Montañas Nubladas y más allá de las puertas de Moria. En Aman existen unos jardines llamados Lórien, destinados al reposo y la curación de las almas.</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal7">
			<div class="popup">
				...
				<div class="container-text">
					<h2>Erebor</h2>
					<p>Erebor, también llamada la Montaña Solitaria, es un lugar ficticio perteneciente al legendarium del escritor J. R. R. Tolkien y que aparece en su novela El hobbit. Se trata de una elevación aislada situada al noreste de Rhovanion, que fue arrebatada por un dragón, llamado Smaug, al rey Thrór de los enanos.</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal8">
			<div class="popup">
				...
				<div class="container-text">
					<h2>Bosque Negro</h2>
					<p>El Bosque Negro (Mirkwood en inglés), también llamado Taur-nu-Fuin o Taur-e-Ndadelos, fue un enorme bosque situado en Rhovanion, al nordeste de la Tierra Media. Conocido anteriormente como el Gran Bosque Verde, desde la construcción de la fortaleza de Dol Guldur por parte de Sauron, una gran sombra se cernió sobre el bosque, pasando a llamarse Bosque Negro.</p>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
		...
		<div class="container-all" id="modal9">
			<div class="popup-promo">
				...
				<div class="container-text">
					...
					<span>Atraccion 1: </span>
					<span>Atraccion 2: </span>
					<span><i class="fas fa-hourglass-start"></i> Tiempo:</span>
					<span><i class="fas fa-users"></i> Cupo:</span>
					<span><i class="fas fa-dollar-sign"></i> Precio:</span>
				</div>
